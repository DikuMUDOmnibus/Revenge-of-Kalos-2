 ...
 */
    ...
    {
 	"limbo scythe",      99,
 	spell_limbo_scythe,  TAR_CHAR_OFFENSIVE, POS_FIGHTING,
 	NULL,                SLOT(559),  20, 12,
 	"limbo scythe	",   "!Limbo Scythe!"
    },

    {
	"circle",		99,
	spell_null,		TAR_CHAR_OFFENSIVE,	POS_FIGHTING,
	&gsn_circle,	SLOT(0),	20,	12,
...

    {
        "pyrokinesis",               99,
        spell_null,             TAR_CHAR_OFFENSIVE,     POS_FIGHTING,
        &gsn_pyro,    SLOT(0),        20,     12,
        "Pyrokinesis attack #1#bDESTROYS#n",  "!Pyro!"
    },
