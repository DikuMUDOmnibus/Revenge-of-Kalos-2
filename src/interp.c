...
const	struct	cmd_type	cmd_table	[] =
{
    ...
    /* olc */
    { "edit",		do_olc,		POS_DEAD, 7, LOG_NORMAL},
    ...
    { "makepreg",	do_makepreg,	POS_DEAD,	 10, LOG_NORMAL },
    ...
    * { "donate",	        do_donate,	POS_SITTING,	 0,  LOG_NORMAL	},*/
    ...
    { "score",		do_newscore,	POS_DEAD,	 0,  LOG_NORMAL	},
    ...
    { "introduce",	do_introduce,	POS_STANDING,	 0,  LOG_NORMAL	},
    { "xemot",		do_huh,		POS_DEAD,	 0,  LOG_NORMAL },
    { "xemote",		do_xemote,	POS_SITTING,	 0,  LOG_NORMAL },
    { "xsocial",	do_huh,		POS_DEAD,	 0,  LOG_NORMAL },
    { "xsocials",	do_xsocials,	POS_DEAD,	 0,  LOG_NORMAL },
   ...
   /* { "showartifacts",	do_show_artifacts,POS_SITTING,	 1,  LOG_NORMAL	},  */
    ...
    { "color",	do_color,	POS_DEAD, 1,	LOG_NORMAL },
    ...
    { "finger",		do_finger,	POS_SITTING,	 0,
LOG_NORMAL	},
    ...
    { "gravetravel",    do_gravetravel, POS_STANDING,    3,  LOG_NORMAL }, 
   ...
   /* { "claninfo",	do_show_clan_info,POS_SITTING,	 1,  LOG_NORMAL	},  */
    ...
    { "demonsword",	do_demonsword, POS_STANDING, 3,	LOG_NORMAL },
    { "dtoken",         do_dtoken,      POS_STANDING,    3,  LOG_NORMAL },
    { "demonform",      do_demonform,   POS_STANDING,    3,  LOG_NORMAL },   
    
    { "demondrain",     do_demondrain,  POS_STANDING,    3,  LOG_NORMAL },
    { "demonfire",      do_demonfire,   POS_STANDING,    3,  LOG_NORMAL },
    { "discipline",     do_discipline,	POS_STANDING,	 5,  LOG_NORMAL	},
    { "immortaleyes",   do_immortaleyes,POS_STANDING,    3,  LOG_NORMAL },
    ...
    { "hguide",		do_hguide,	POS_STANDING,	3, LOG_NORMAL },
...
/*start drow section */
/*New drows,- Xkilla  */
    { "webtalk",        do_webtalk,     POS_DEAD,        0,  LOG_NORMAL },
    { "infect",         do_infect,      POS_STANDING,    0,  LOG_ALWAYS },
    { "inherit",        do_inherit,     POS_DEAD,        0,  LOG_NORMAL },    
    { "toughen",        do_toughen,     POS_DEAD,        0,  LOG_NORMAL }, 
    { "foureyes",       do_foureyes,    POS_DEAD,        0,  LOG_NORMAL },
/* end drow */
    { "inconnu",	do_inconnu,	POS_STANDING,	 3,  LOG_NORMAL	},
    { "kakusu",		do_kakusu,	POS_STANDING,	 3,  LOG_NORMAL	}, /* Enhanced Ninja
Hide */
...
*/
    ...
    { "mysteriousshroud",do_mysteriousshroud, POS_STANDING,   3, LOG_NORMAL },
    ...
    { "shadowdrain",	do_shadowdrain, POS_STANDING,	 3,  LOG_NORMAL	},
    ...
    { "mourn",          do_mourn,       POS_SITTING,     3,  LOG_NORMAL },
    ...
    { "lunarportal",    do_moongate,    POS_STANDING,    3,  LOG_NORMAL },
    { "stab",           do_stab,        POS_STANDING,    3,  LOG_NORMAL },
    { "gaia",		do_gaia,	POS_STANDING,	 0,  LOG_NORMAL	},
    { "klaive",      do_klaive,   POS_STANDING,   0, LOG_NORMAL},
    { "moonarmor",      do_moonarmor,   POS_STANDING,   0, LOG_NORMAL},
    ...
    { "upgrade", do_upgrade,  POS_DEAD,    3,  LOG_NORMAL },
    /*
     * Immortal commands.
     */
   ...
   /* { "fileupdate",	do_fileupdate,	POS_DEAD,	12,  LOG_ALWAYS	},*/
    ...
    { "hotboot",	do_hotboot,	POS_DEAD,	10,  LOG_ALWAYS },
    ...
    { "restore",	do_restore,	POS_MORTAL,	 8,  LOG_ALWAYS	},
...
/*Smoo's Vampire Additions*/
    { "bloodriver",	do_reach,	POS_STANDING,	 0,  LOG_NORMAL},
    { "vampcreate",	do_vampcreate,	POS_STANDING,	 3,  LOG_NORMAL	},

/*Arcane stuff*/
    { "oldscore",       do_oldscore,     POS_DEAD,        0,  LOG_NORMAL},
    { "findexp",        do_findexp,      POS_DEAD,        0,  LOG_NORMAL},
    { "timers",		do_timers,	 POS_DEAD,	  0,  LOG_NORMAL},
    { "imptalk",	do_imptalk,	POS_DEAD,	  12,  LOG_NORMAL},
    { "delete",         do_delete,       POS_STANDING,    2,  LOG_ALWAYS},
    { "updatetick",	do_updatetick,   POS_DEAD,	  11, LOG_ALWAYS},
/* Remove arena: clear a players flags.
   Clear Arena:  used in fight.c
   Lock Arena:   prevents players from using arena.
   The rest are just arena shit.
*/
 
    { "aagree",		do_aagree, 	 POS_DEAD,	  0,  LOG_NORMAL},
    { "adecline",       do_adecline,       POS_DEAD,      0,  LOG_NORMAL},
    { "achallenge",     do_achallenge,     POS_DEAD,      0,  LOG_NORMAL},
    { "qbet",           do_qbet,           POS_DEAD,      0,  LOG_NORMAL},
    { "expbet",		do_expbet,	 POS_DEAD,	  0,  LOG_NORMAL},
    { "lockarena",	do_lockarena,	 POS_DEAD,	  7,  LOG_NORMAL},
    { "cleararena",	do_cleararena,	POS_DEAD,	  10,  LOG_NORMAL},
    { "removearena",    do_removearena, POS_DEAD,	   7,  LOG_ALWAYS},
    { "aclaim",		do_aclaim,	POS_DEAD,	   0, LOG_NORMAL},	

/* Bugged
    { "bonus",		do_bonus,	 POS_DEAD,	 12,  LOG_NORMAL},
*/

/*Shatan functions*/
     { "obtain",         do_obtain,   POS_DEAD,         3, LOG_NORMAL },        
     { "redeem",         do_redeem,   POS_DEAD,         3, LOG_NORMAL },
     { "enroll",         do_enroll,   POS_DEAD,         3, LOG_NORMAL },
     { "warps",          do_warps,    POS_DEAD,         3, LOG_NORMAL },
     { "legions",	 do_legions,  POS_DEAD,		3, LOG_NORMAL },
/*shatan channel renamed to pray by request of tanais,
he wanted a mutter social.*/
     { "leech",		 do_leech,    POS_DEAD,		3, LOG_NORMAL },
/*added for immortals to talk on the shatan channel*/
     { "shatan",         do_mutter,   POS_DEAD,         8, LOG_NORMAL },
/*Hydra stuff*/
    { "transform",	do_transform,   POS_DEAD,	  0, LOG_NORMAL },
    { "ready",		do_ready,	POS_DEAD,  	  0, LOG_NORMAL	}, 
    { "powers", 	do_powers,	POS_DEAD,	  0, LOG_NORMAL },
    { "gain",		do_gain,	POS_DEAD,	  0, LOG_NORMAL },
    { "roar",           do_roar,        POS_DEAD,        0,  LOG_NORMAL },
    { "hinfo",          do_hinfo,       POS_DEAD,        0,  LOG_NORMAL },
    { "hydras",         do_hydras,       POS_DEAD,        0,  LOG_NORMAL },
    { "reach",		do_reach,	POS_STANDING,	 0,  LOG_NORMAL	},
/*Illusionist shit*/
    { "morph",		do_morph, 	POS_DEAD, 	0,   LOG_NORMAL	},
/*Xkilla stuff*/
    { "newclass",       do_newclass,    POS_DEAD,        11, LOG_ALWAYS },
    { "secset",         do_secset,      POS_DEAD,        12, LOG_ALWAYS },
    { "note",           do_note,        POS_DEAD,        0,  LOG_NORMAL },
    { "board",          do_board,       POS_DEAD,         0, LOG_NORMAL }, 
    { "version",	do_version,     POS_DEAD, 	  0, LOG_NORMAL },
    { "newscore",       do_newscore,    POS_DEAD,         1,  LOG_NORMAL },
    { "pstat",          do_pstat,       POS_DEAD,        11,  LOG_NORMAL },
    { "addlag",         do_addlag,      POS_DEAD,        11,  LOG_NORMAL },
    { "undeny",         do_undeny,      POS_DEAD,        11,  LOG_NORMAL },
    { "bounty",         do_bounty,      POS_DEAD,        1,  LOG_NORMAL },
    { "notell",         do_notell,      POS_DEAD,        9,  LOG_NORMAL },   
    { "smite",          do_smite,       POS_DEAD,        11,  LOG_NORMAL },
    { "prefi",		do_prefi,	POS_DEAD,	 0,   LOG_NORMAL },
    { "prefix",		do_prefix,	POS_DEAD,	 0,   LOG_NORMAL },
    { "alia",		do_alia,	POS_DEAD,	 0,   LOG_NORMAL },
    { "alias",		do_alias, 	POS_DEAD,	 0,   LOG_NORMAL },
    { "unalias",        do_unalias,     POS_DEAD,        0,   LOG_NORMAL },    
    { "info",           do_info,        POS_DEAD,       11,   LOG_NORMAL },   
    { "aquest",         do_aquest,      POS_DEAD,       11,   LOG_ALWAYS },   
    { "afk",            do_afk,         POS_DEAD,        0,   LOG_ALWAYS }, 
    { "loadhelp",       do_loadhelp,    POS_DEAD,       11,   LOG_ALWAYS },        
    { "gsocial",        do_gsocial,     POS_DEAD,        0,   LOG_NORMAL },
    { "beep",           do_beep,        POS_DEAD,        0,   LOG_NORMAL },
    { "nobeep",         do_nobeep,      POS_DEAD,        0,   LOG_NORMAL },        
    { "newlock",        do_newlock,     POS_DEAD,        10,  LOG_NORMAL },
    { "numlock",        do_numlock,     POS_DEAD,        10,  LOG_NORMAL },
    { "gemote",         do_gemote,      POS_DEAD,         0,  LOG_NORMAL }, 
    { "selfrestore",    do_selfrestore, POS_DEAD,         0,  LOG_NORMAL },
    { "tag",        do_tag,     POS_STANDING,    0,  LOG_NORMAL},
    { "notag",      do_notag,   POS_STANDING,    0,  LOG_NORMAL},
    { "pretitle",       do_pretitle,    POS_DEAD,        10,  LOG_NORMAL },
    { "auction",        do_auction,     POS_SLEEPING,    0,  LOG_NORMAL}, 
    { "jog",            do_jog,         POS_STANDING,    0,  LOG_NORMAL},
    { "stag",		do_stag,	POS_DEAD, 	10,  LOG_ALWAYS},
    { "ftag",		do_ftag,	POS_SLEEPING,   11,  LOG_NORMAL},
    ...
    { "autotick",       do_autotick,    POS_RESTING,     0,  LOG_NORMAL},     
    { "mystic",         do_mystic,      POS_DEAD,        0,  LOG_NORMAL }, 
    { "makesave",       do_makesave,    POS_RESTING,    11,  LOG_NORMAL},   
    { "favorite",       do_favorite,    POS_RESTING,     0,  LOG_NORMAL}, 
    { "favplace",       do_favplace,    POS_RESTING,     0,  LOG_NORMAL}, 
    { "doubleexp",      do_doubleexp,   POS_DEAD,       12,  LOG_NORMAL },      


/*
 * Aliens by XKilla
 */
    { "aliens",         do_aliens,      POS_DEAD,        0,  LOG_NORMAL },
    { "aclass",         do_aclass,      POS_DEAD,        0,  LOG_NORMAL },
    { "abduct",         do_abduct,      POS_DEAD,        0,  LOG_NORMAL },
    { "planet",         do_planet,      POS_DEAD,        0,  LOG_NORMAL },
    { "probe",          do_probe,       POS_DEAD,        0,  LOG_NORMAL },
    { "beam",           do_beam,        POS_DEAD,        0,  LOG_NORMAL },
    { "radar",          do_radar,       POS_DEAD,        0,  LOG_NORMAL },
    { "space",          do_space,       POS_DEAD,        0,  LOG_NORMAL }, 
    { "pyrokinesis",    do_pyrokinesis, POS_DEAD,        0,  LOG_NORMAL },
    { "biomorph",       do_biomorph,    POS_DEAD,        0,  LOG_NORMAL },   
    { "prince",         do_prince,      POS_DEAD,        0,  LOG_NORMAL },          
    { "consume",        do_consume,     POS_DEAD,        0,  LOG_NORMAL },
    { "spaceeyes",      do_spaceeyes,   POS_DEAD,        0,  LOG_NORMAL },  
    { "aliencreate",    do_aliencreate, POS_DEAD,        0,  LOG_NORMAL },
    { "ptoken",         do_ptoken,      POS_DEAD,        0,  LOG_NORMAL },
    { "brood",          do_brood,       POS_DEAD,       11,  LOG_ALWAYS },
    { "alienpowers",    do_alienpowers, POS_DEAD,        0,  LOG_NORMAL },
    { "autoconsume",    do_autoconsume, POS_DEAD,        0,  LOG_NORMAL },

/*
 *Angels by Xkilla
 */ 
    { "angelgift",     do_angelgift,    POS_DEAD,        0,  LOG_NORMAL },
    { "godlysight",    do_godlysight,   POS_DEAD,        0,  LOG_NORMAL },
    { "purify",        do_purify,       POS_DEAD,        0,  LOG_NORMAL },
    { "etherform",     do_etherform,    POS_DEAD,        0,  LOG_NORMAL },
    { "wraithofgod",   do_wraithofgod,  POS_DEAD,        0,  LOG_NORMAL },
    { "angelwings",    do_angelwings,   POS_DEAD,        0,  LOG_NORMAL },
    { "angellist",     do_angellist,    POS_DEAD,        0,  LOG_NORMAL },
    { "trueform",      do_trueform,     POS_DEAD,        0,  LOG_NORMAL },
    { "multiarm",      do_multiarm,     POS_DEAD,        0,  LOG_NORMAL },
    /*
     * End of list.
     */
...
const	struct	social_type	social_table [] =
{
...

    {
        ...
        "You mutter at $M, annoyed.",
        "$n mutters at $M, obviosly annoyed.",
        "$n mutters at you, $e is annoyed.",
        "You mutter under your breath.",
        "$n mutters under $s breath.",
    },
...
if ( !IS_NPC(ch) && IS_SET(ch->extra, EXTRA_AFK) )
    ...
    /*Lets see who is doing what? -Ferric*/    strcpy( buf, argument);
    ...
    {
	if (!str_prefix(logline, "delete" ) )
	    strcpy(logline, "Delete XXXXXX");
...
bool check_xsocial( CHAR_DATA *ch, char *command, char *argument )
{
    ...
    {
    case POS_DEAD:
	send_to_char( "Necrophilia doesn't work vice versa.\n\r", ch );
	return TRUE;

    case POS_INCAP:
    case POS_MORTAL:
	send_to_char( "Sex is the last thing on you mind right now.\n\r", ch );
	return TRUE;

    case POS_STUNNED:
	send_to_char( "You are too stunned to know where to put it.\n\r", ch );
	return TRUE;

    case POS_SLEEPING:
	send_to_char( "Having wet dreams again??\n\r", ch );
	return TRUE;
